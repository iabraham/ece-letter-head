...
\providecommand\lllinioisI{Illinois-I.pdf}
...
\AtBeginDocument{%
    ...
    \begin{textblock*}{4.0in} (3.5in,0.45in)
      \begin{flushright}
        {%
	\color{UIblue}
	\fontsize{10}{12}
...
\fancypagestyle{last-page}{
	\fancyfoot[L]{%
		...
		\end{textblock*}
		\begin{textblock*}{0.2\textwidth}[0.0,1.0](7.275in,10.35in)		
							\includegraphics[height=0.3in]{Illinois-I}
		\end{textblock*}
	}
}
